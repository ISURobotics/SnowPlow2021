class FuncGenerator(object):
    ...
    def move_forward(self, meters):
        ...
        if meters < 0:
            ...
            return lambda p_sensors: self.mover.move_backward(p_sensors, -meters)
        return lambda p_sensors: self.mover.move_forward(p_sensors, meters)
    ...
    def rotate_left(self, degrees):
        ...
        return lambda p_sensors: self.mover.rotate_left(p_sensors, degrees)
    ...
    def rotate_right(self, degrees):
        ...
        return lambda p_sensors: self.mover.rotate_right(p_sensors, degrees)
